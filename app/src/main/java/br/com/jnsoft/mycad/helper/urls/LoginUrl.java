...
public class LoginUrl {
    ...
    private static String tabela = "login/";

    public static final String Auth = ServerPacth + tabela + "auth.php";
    public static final String ValidUser = ServerPacth + tabela + "valida.php";
